...
_Данный функционал ввода и вывода фиата находится в разработке._
...
**Kuna Code API объект** \
Почти все методы возвращают одинаковую структуру данных для Kuna Code. Будь то создание, или получение конкретного кода, или получение списка кодов.
