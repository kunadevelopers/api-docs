...
[Приватное и торговое API]: #приватное-и-торговое-api
  ...
  [Сохраненные Карты / Адреса]:                 #сохранные-карты-аккаунты
...
😱__**Данный функционал находится в разработке.** Советуем воздержаться от попыток использовать API для ввода и вывода Фиата, так как некоторая часть может работать не так как ожидается.__
