...
Этот метод еще в разработке и появится так скоро как сможем.
...
Этот метод не доступен. Но вы можете воспользоватся им из API v3.
...
# Вернет список всех активных ордеров только на паре BTC/UAH
