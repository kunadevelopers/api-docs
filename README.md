...
| Параметр                | Описание                                       |
|-------------------------|------------------------------------------------|
| `type` (string)         | Не обязательный параметр для фильтрации операций по вводу или выводу.
                             * Если не указать, то метод вернет и вводы и выводы
                             * `withdraws` - вернет только операции вывода с аккаунта
                             * `deposits` - вернет только операции зачисления |
