...
[Подпись для приватных методов]: #4-подпись-для-приватных-методов
...
| `Kun-Nonce`     | Метка времени запроса. Указывается в формате Unix Time Stamp в милисекундах (ms). Только для приватных методов. Только для приватных методов. |
| `Kun-ApiKey`    | Публичный ключ вашего API Token. Только для приватных методов. Только для приватных методов. |
| `Kun-Signature` | Подпись запроса. Только для приватных методов. Только для приватных методов. |



### 4) Подпись для приватных методов
...
### 5) Пример приватного метода с cURL
...
[
  # пример для фиатной валюты
  {
    ...
    # возможные варинты: advcash_wallet, payeer, perfectmoney_account, perfectmoney_transfer, kuna_code, payment_card
    "code": "advcash_wallet",
