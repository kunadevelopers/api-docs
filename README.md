...
[Ввод и вывод криптовалюты]: #ввод-и-вывод-криптовалюты
  ...
  [Создание заявки на вывод криптовалюты]:  #создание-заявки-на-вывод-криптовалюты
...
⚠️ Если у вас включено подтверждение по почте — то все выводы нужно будет подтверждать. При работе с API с выводами лучше отключать подтверждение по почте.
